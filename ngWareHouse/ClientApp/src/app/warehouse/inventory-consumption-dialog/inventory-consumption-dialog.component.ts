...
@Component({
  selector: 'app-inventory-consumption-dialog',
  templateUrl: './inventory-consumption-dialog.component.html',
  styleUrls: ['./inventory-consumption-dialog.component.css']
})
export class InventoryConsumptionDialogComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<InventoryConsumptionDialogComponent>,
